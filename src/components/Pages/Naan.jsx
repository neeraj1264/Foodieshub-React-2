...
const Data = [
  { id: 89, name: 'Plain Naan',   image: '/img/dinner/plainnaan-min.jpeg',   description: 'Plain naan is a traditional Indian flatbread that is soft, fluffy, and typically served as an accompaniment to various curries, gravies, and other main dishes.', price: 25, mrp: '30' },
  ...
  { id: 91, name: 'Stuff Naan',   image: '/img/dinner/stuffnaan-min.jpeg',   description: 'Stuffed naan is often brushed with butter or ghee after cooking, enhancing its flavor and providing a rich finish.', price: 40, mrp: '50' },
  ...
  { id: 95, name: 'Tandoori Roti',image: '/img/dinner/tandooriroti-min.jpeg',description: 'Tandoori roti is a popular Indian flatbread that is cooked in a tandoor, which is a traditional clay oven.', price: 12, mrp: '15' },
  { id: 96, name: 'Tawa Roti',    image: '/img/dinner/tawaroti-min.jpeg',    description: 'Tawa roti is a type of Indian flatbread that is cooked on a tawa, which is a flat or concave griddle. ', price: 12, mrp: '15' },
  ...
  { id: 99, name: 'Plain Rice',   image: '/img/dinner/plainrice-min.jpeg',   description: 'Plain rice is a simple and versatile staple food that is a dietary foundation in many cultures around the world.', price: {priceH: '40', priceF: '60'}, mrp: '60' },
