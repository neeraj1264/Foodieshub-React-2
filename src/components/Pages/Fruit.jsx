...
const Data = [
  ...
  { id: 113, name: 'Lean & Green Fruit Chaat  ', image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'A combination of fruits known for aiding in weight loss, such as papaya, pineapple, and pomegranate.'},
  { id: 114, name: 'Energy Boost Blend  ',       image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'Combining fruits like banana, apple, and grapes for a boost of energy and vitality.'},
  { id: 115, name: 'Digestive Delight Mix  ',    image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: ' Featuring fruits like chiku, papaya, and pineapple known for their digestive benefits.'},
  { id: 116, name: 'Immunity Power Pack  ',      image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: ' Immunity Power Pack: A mix of fruits rich in vitamins and antioxidants, such as mango, grapes, and pomegranate, to boost immunity  '},
  { id: 117, name: 'Detox Fusion Feast  ',       image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: ' Combining detoxifying fruits like watermelon, pineapple, and pomegranate for a cleansing effect.  '},
  { id: 118, name: 'Muscle Builder Mix  ',       image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: ' Detox Fusion Feast: Combining detoxifying fruits like watermelon, pineapple, and pomegranate for a cleansing effect.  '},
 ];
