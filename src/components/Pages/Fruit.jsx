...
const Data = [
  ...
  { id: 113, name: 'Lean & Green Fruit Chaat  ', image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'PAPAYA - GRAPES - POMEGRANATE. this combination of fruits known for aiding in weight loss.'},
  { id: 114, name: 'Energy Boost Blend  ',       image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'BANANA - APPLE - GRAPES. this combination of fruits known for boost of energy and vitality.'},
  { id: 115, name: 'Digestive Delight Mix  ',    image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'CHIKU - PAPAYA - BANANA. this combination of fruits known for their digestive benefits.'},
  { id: 116, name: 'Immunity Power Pack  ',      image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'MANGO - GRAPES - POMEGRANATE. this combination of fruits rich in vitamins and antioxidants to boost immunity  '},
  { id: 118, name: 'Muscle Builder Mix  ',       image: '/img/fruit/fruit.jpeg',      size: {size1: '200 grams' , size2: '400 grams'}, price: {priceH: 60, priceF: 110}, mrp:'100', description: 'BANANA - MANGO - CHIKU. this combination of fruits high in protein and nutrients to support muscle growth and recovery. '},
 ];
